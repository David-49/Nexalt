...
import { Container, createStyles, List } from '@mantine/core';
...
const LIST_TABS = [
  {
    id: 1,
    label: 'Dernières notifications',
    icon: <IconBell size={25} />,
    url: '#notifications',
  },
  {
    id: 2,
    label: 'Visibilité',
    icon: <IconEye size={25} />,
    url: '#visibility',
  },
  {
    id: 3,
    label: 'Statistique des 7 derniers jours',
    icon: <IconChartBar size={25} />,
    url: '#statistics',
  },
  {
    id: 4,
    label: 'Mots-clés utilisés pour vous trouver',
    icon: <IconKey size={35} />,
    url: '#keywords',
  },
  {
    id: 5,
    label: 'Personnes qui ont vus votre profil',
  ...
  return (
    <Container fluid className={classes.containerPage}>
      <Head>
        ...
        <meta
          name="description"
          content="Vous pourrez retrouver toute les informations nécessaire sur votre tableau de bord"
        />
      ...
      <section className={classes.board}>
        <div className={classes.boardInner}>
          ...
          <List className={classes.boardMenu}>
            {LIST_TABS.map((tab) => (
              <List.Item
                key={tab.id}
                className={`${classes.liBoardMenu} ${
                  activeTab === tab.id && classes.liActiveBoardMenu
                }`}
              >
                <Link href={tab.url} passHref>
                  <a
                    ...
                    className={`${classes.linkBoardMenu} ${
                      activeTab === tab.id && classes.linkActiveBoardMenu
                    }`}
                  >
                    {tab.icon}
                    {tab.label}
            ...
            <form className={classes.searchBarForm}>
              <div className={classes.searchBar}>
                <input
                  ...
                  type="text"
                  placeholder="Rechercher un métier, une personne, etc..."
                />
                <svg
                  className={classes.svgSearchInput}
                  version="1.1"
                  id="Calque_1"
                ...
                >
                  <g id="Loupe" transform="translate(1 1)">
                    <path
                      d="M21.1,19.7l-4.2-4.2c1.4-1.7,2.3-4,2.3-6.4C19.2,3.5,14.7-1,9.1-1C3.5-1-1,3.5-1,9.1c0,5.6,4.5,10.1,10.1,10.1
          ...
          <div className={classes.boardContent} id="notifications">
            <div className={classes.innerBoardContent}>
              <div className={classes.titleBoardContent}>
                <svg
                  className={classes.svgTitleBoardContent}
                  version="1.1"
                  id="Calque_1"
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                >
                  <path
                    d="M22.2,19.1H1.1c-0.5,0-0.9-0.3-1.1-0.8c-0.1-0.5,0.1-1,0.5-1.2c0,0,3-2.1,3-9.2C3.6,3.4,7.3-0.1,11.7,0c0.1,0,0.1,0,0.2,0
                  ...
                  />
                  <path
                    d="M11.6,24.7c-0.6,0-1.2-0.2-1.7-0.5C9.4,24,9,23.5,8.7,23c-0.3-0.5-0.1-1.2,0.4-1.5c0.5-0.3,1.2-0.1,1.5,0.4
            ...
            <ul className={classes.boardList}>
              <li className={classes.purpleLi}>
                <div className={classes.contentOne}>
                  <svg
                    className={classes.svgContentOne}
                    version="1.1"
                    id="Calque_1"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                  ...
                  >
                    <path
                      d="M11.8,20.6c-7.4,0-11.5-8.1-11.7-8.4c-0.1-0.2-0.1-0.5,0-0.7C0.3,11.1,4.4,3,11.8,3s11.5,8.1,11.7,8.4
                    ...
                    />
                    <path
                      d="M11.8,15.6c-2.1,0-3.8-1.7-3.8-3.8C8,9.7,9.7,8,11.8,8s3.8,1.7,3.8,3.8C15.6,13.9,13.9,15.6,11.8,15.6z M11.8,9.6
                                    c-1.2,0-2.2,1-2.2,2.2s1,2.2,2.2,2.2s2.2-1,2.2-2.2S13,9.6,11.8,9.6z"
                    />
                  </svg>
                  <span className={classes.titleContentOne}>
                    Votre profil à été vu par une personne
                  </span>
                </div>
                <Link href="">
                  <a className={classes.buttonPremium}>
                    <svg
                      className={classes.svgButtonPremium}
                      version="1.1"
                      id="Calque_1"
                      xmlns="http://www.w3.org/2000/svg"
                      xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                <div className={classes.contentOne}>
                  ...
                  >
                    <g id="Msg" transform="translate(-51 -290)">
                      <path
                        d="M52,312c-0.1,0-0.3,0-0.4-0.1c-0.4-0.2-0.6-0.5-0.6-0.9v-17.8c0-1.8,1.4-3.2,3.2-3.2h15.6c1.8,0,3.2,1.4,3.2,3.2v11.1
                  ...
                  <span className={classes.titleContentOne}>
                    Vous avez reçu un nouveau message de Brio Academy
                  </span>
                </div>
              </li>
              <li className={classes.purpleLi}>
                <div className={classes.contentOne}>
                  ...
                  <span className={classes.titleContentOne}>
                    Vous avez reçu un message de Trois Double Vé
                  </span>
                </div>
              </li>
              <li className={classes.whiteLi}>
                <div className={classes.contentOne}>
                  ...
                  <span className={classes.titleContentOne}>
                    Votre profil à été vu par deux personnes
                  </span>
                </div>
                <Link href="">
                  <a className={classes.buttonPremium}>
              ...
              <li className={classes.purpleLi}>
                <div className={classes.contentOne}>
                  ...
                  <span className={classes.titleContentOne}>
                    Votre profil est apparu 54 fois dans les recherches,
                    continuez comme ça !
                  </span>
                </div>
              </li>
            ...
            <div className={classes.contentGroup}>
              <div className={classes.visibilityContent}>
                <div className={classes.visibilityInnerContent}>
                  <svg
                    className={classes.svgVisibilityInnerContent}
                    version="1.1"
                    id="Calque_1"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                  ...
                  >
                    <g id="Fav" transform="translate(-49 -345.531)">
                      <path
                        d="M62,370c-0.3,0-0.5-0.1-0.7-0.3l-10.2-10.2c-1.4-1.4-2.1-3.2-2.1-5.2c0-2,0.8-3.8,2.1-5.2c2.9-2.9,7.5-2.9,10.3,0l0.5,0.5
                ...
                <p className={classes.description}>
                  C'est le nombre de personnes qui ont ajouté votre profil à
                  leur favoris
                </p>
              </div>
              <div className={classes.visibilityContent}>
                ...
                <p className={classes.description}>
                  C'est le nombre d'apparitions de votre profil sur notre moteur
                  de recherche
                </p>
              </div>
              <div className={classes.visibilityContent}>
                ...
                <p className={classes.description}>
                  C'est le nombre de personnes qui ont vu votre profil
                </p>
              </div>
            </div>
          </div>
            ...
            <div className={classes.innerBoardContent}>
              <div className={classes.titleBoardContent}>
                ...
                >
                  <path
                    id="Tracé_49"
                    d="M5.9,21.8h2.7c0.3,0,0.5-0.2,0.5-0.5V0.5C9.1,0.2,8.9,0,8.6,0H5.9C5.7,0,5.5,0.2,5.5,0.5v20.9
                                C5.5,21.6,5.7,21.8,5.9,21.8z"
                  />
                  <path
                    id="Tracé_50"
                    d="M0.5,21.8h2.7c0.2,0,0.5-0.2,0.5-0.5v-8.1c0-0.2-0.2-0.5-0.5-0.5H0.5C0.2,12.8,0,13,0,13.2v8.1
                                C0,21.6,0.2,21.8,0.5,21.8C0.5,21.8,0.5,21.8,0.5,21.8z"
                  />
                  <path
                    id="Tracé_51"
                    d="M11.4,21.8h2.7c0.3,0,0.5-0.2,0.5-0.5c0,0,0,0,0,0V9.6c0-0.3-0.2-0.5-0.5-0.5c0,0,0,0,0,0h-2.7
                                c-0.3,0-0.5,0.2-0.5,0.5c0,0,0,0,0,0v11.7C10.9,21.6,11.1,21.8,11.4,21.8C11.4,21.8,11.4,21.8,11.4,21.8z"
                  />
                  <path
                    id="Tracé_52"
                    d="M16.4,4.2v17.2c0,0.3,0.2,0.5,0.5,0.5c0,0,0,0,0,0h2.7c0.3,0,0.5-0.2,0.5-0.5c0,0,0,0,0,0V4.2
            ...
            <div className={classes.innerBoardContent}>
              <div className={classes.titleBoardContent}>
                ...
                >
                  <path
                    id="Icon_awesome-key"
                    d="M21.8,7.5c0,4.1-3.4,7.5-7.5,7.5c-0.5,0-0.9,0-1.4-0.1l-1,1.2c-0.2,0.2-0.5,0.3-0.8,0.3H9.5v1.7
          ...
          <div className={classes.boardContent} id="views">
            <div className={classes.innerBoardContent}>
              <div className={classes.titleBoardContent}>
                ...
                >
                  <path
                    d="M13,2c-3,0-5.5,2.5-5.5,5.5S10,13,13,13s5.5-2.5,5.5-5.5S16,2,13,2 M13,15.8c-3.7,0-11,1.8-11,5.5V24h22v-2.8
              ...
              <li className={classes.profilesViewedLi}>
                <Link href="">
                  <a className={classes.linkProfilesViewed}>
                    <div className={classes.imgMask}>
                      <div
                        className={`${classes.profileImg} && ${classes.p15}`}
                      >
                        <Image
              ...
              <li className={classes.profilesViewedLi}>
                <Link href="">
                  <a className={classes.linkProfilesViewed}>
                    <div className={classes.imgMask}>
                      <div
                        className={`${classes.profileImg} && ${classes.p16}`}
                      >
                        <Image
              ...
              <li className={classes.profilesViewedLi}>
                <Link href="">
                  <a className={classes.linkProfilesViewed}>
                    <div className={classes.imgMask}>
                      <div
                        className={`${classes.profileImg} && ${classes.p17}`}
                      >
                        <Image
              ...
              <li className={classes.profilesViewedLi}>
                <Link href="">
                  <a className={classes.linkProfilesViewed}>
                    <div className={classes.imgMask}>
                      <div
                        className={`${classes.profileImg} && ${classes.p18}`}
                      >
                        <Image
              ...
              <li className={classes.profilesViewedLi}>
                <Link href="">
                  <a className={classes.linkProfilesViewed}>
                    <div className={classes.imgMask}>
                      <div
                        className={`${classes.profileImg} && ${classes.p19}`}
                      >
                        <Image
              ...
              <li className={classes.profilesViewedLi}>
                <Link href="">
                  <a className={classes.linkProfilesViewed}>
                    <div className={classes.imgMask}>
                      <div
                        className={`${classes.profileImg} && ${classes.p20}`}
                      >
                        <Image
