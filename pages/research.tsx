        ...
        <div className={classes.filterInner}>
          ...
          <form className={classes.filters}>
            ...
            <button className={classes.filterSearchButton} type="submit">
              <svg
                className={classes.svgFilterSearchButton}
                version="1.1"
                id="Calque_1"
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p2}`}>
                    <Image
                      src="/assets/images/research/photo_2.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p3}`}>
                    <Image
                      src="/assets/images/research/photo_3.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p4}`}>
                    <Image
                      src="/assets/images/research/photo_4.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p5}`}>
                    <Image
                      src="/assets/images/research/photo_5.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p6}`}>
                    <Image
                      src="/assets/images/research/photo_6.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p7}`}>
                    <Image
                      src="/assets/images/research/photo_7.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p8}`}>
                    <Image
                      src="/assets/images/research/photo_8.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p9}`}>
                    <Image
                      src="/assets/images/research/photo_9.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p10}`}>
                    <Image
                      src="/assets/images/research/photo_10.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
              ...
              <a className={classes.card}>
                <div className={classes.imgMask}>
                  <div className={`${classes.cardImg} ${classes.p12}`}>
                    <Image
                      src="/assets/images/research/photo_12.jpg"
                      alt="student"
                      width="1080"
                      height="1400"
                      objectFit='cover'
