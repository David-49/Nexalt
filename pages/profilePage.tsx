...
const LIST_TABS = [
  ...
  { id: 3, label: 'Compétences', url: '#skills' },
  { id: 4, label: 'Expériences', url: '#experiences' },
  { id: 5, label: 'Formations', url: '#formations' },
  { id: 6, label: 'Langues', url: '#languages' },
  { id: 7, label: 'Catégories', url: '#categories' },
];
        ...
        <div className={classes.boardInner}>
          <Link href="/research">
            <a className={classes.title}>
              ...
              >
                <path
                  d="M15.2,18.1c0.4,0.4,0.4,1.1,0,1.5c-0.2,0.2-0.5,0.3-0.7,0.3c-0.3,0-0.5-0.1-0.7-0.3l-8.9-8.9c-0.4-0.4-0.4-1.1,0-1.5
          ...
          <div className={classes.topProfile}>
            <div className={classes.imgProfileMask}>
              <div className={classes.imgProfilePosition}>
                <Image
                  src="/assets/images/research/photo_1.jpg"
                  alt=""
                  width="1080"
                  height="1400"
                />
            ...
            <div className={classes.identity}>
              <div className={classes.identityName}>
                ...
                <svg
                  className={classes.svgIdentityName}
                  version="1.1"
                  id="Calque_1"
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
                ...
                <div className={classes.identityLocalisation}>
                  ...
                  >
                    <path
                      ...
                      d="M15,0C9.1,0,4.4,4.6,4.3,10.5C4.3,18.4,15,30,15,30s10.7-11.6,10.7-19.5C25.6,4.6,20.9,0,15,0z
                  ...
                  <span className={classes.localisationText}>
                    Cherche à Angers, Tours, Paris
                  </span>
                </div>
                <div className={classes.identityRecommandation}>
                  <svg
                    className={classes.svgRecommandation}
                    version="1.1"
                    id="Calque_1"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                  ...
                  >
                    <path
                      ...
                      d="M6.1,13.1H1.4c-0.8,0-1.4,0.6-1.4,1.4v14.1C0,29.4,0.6,30,1.4,30c0,0,0,0,0,0h4.7
                  ...
                  <span className={classes.recommandationText}>
                    7 recommandations
                  </span>
                </div>
              </div>
            ...
            <div className={classes.identityContact}>
              <p className={classes.contactText}>
                Margaux est toujours à la recherche d'une alternance, si son
                profil vous intéresse, contactez la !
              </p>
              <Link href="">
          ...
          <div className={classes.allContent}>
            <div className={classes.firstPartContent}>
              <div className={classes.profileContent} id="about">
                ...
                <p className={classes.profilePresentation}>
                  Hello !<br />
                  <br />
                  Actuellement en deuxième année d’un Bachelor Concepteur
                  Réalisateur Web et Digital, je me spécialise en WebDesign à la
                  rentrée prochaine. Je souhaite faire évoluer mes compétences
                  au sein d’une entreprise dynamique. See you soon …
                </p>
              </div>
              ...
              <div className={classes.profileContent} id="portfolio">
                <div className={classes.profileContentRow}>
                  ...
                  <svg
                    className={classes.svgFullscreen}
                    version="1.1"
                    id="Calque_1"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                  ...
                  >
                    <path
                      ...
                      d="M4.3,19.3H0V30h10.7v-4.3H4.3V19.3z M0,10.7h4.3V4.3h6.4V0H0V10.7z M25.7,25.7h-6.4V30H30
                ...
                <div className={classes.experiencesContent}>
                  <div className={classes.experiencesFirstPart}>
                    ...
                    <div>
                      ...
                      <svg
                        className={classes.svgOfficeLocalisation}
                        version="1.1"
                        id="Calque_1"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink"
                  ...
                  <div className={classes.experiencesSecondPart}>
                    <span className={classes.jobName}>
                      Graphiste | Intégrateur web
                    </span>
                    <div>
                      <span className={classes.jobDate}>
                        Juin 2020 - Août 2020
                      </span>
                      <svg
                        className={classes.svgJobDate}
                        version="1.1"
                        id="Calque_1"
                        xmlns="http://www.w3.org/2000/svg"
                        xmlnsXlink="http://www.w3.org/1999/xlink"
                      ...
                      >
                        <path
                          ...
                          d="M0,31.1c0,1.8,1.4,3.2,3.2,3.2h23.6c1.8,0,3.2-1.4,3.2-3.2V12.9H0V31.1z M21.4,17.9
                  ...
                  <p className={classes.experienceDescription}>
                    Création de logo, de bannières, d’affiches, de retouche
                    photo et de motion design en faisant des animations de logo.
                  </p>
                </div>
                <div className={classes.experiencesContent}>
                  <div className={classes.experiencesFirstPart}>
                  ...
                  <p className={classes.experienceDescription}>
                    Refonte de plusieurs parties du site internet.
                    <br />
                    Maquette sur XD puis intégration de la solution,
                    modification d’un thème wordpress préinstallé.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={classes.secondPartContent}>
              ...
              <div className={classes.profileContent} id="categories">
                ...
                <div className={classes.categoryContent}>
                  <svg
                    className={classes.svgCategoryContent}
                    version="1.1"
                    id="Calque_1"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
                  ...
                  >
                    <path
                      ...
                      d="M9.8,18.1c-2.6,0-4.9,1.7-5.7,4.2C4,22.7,3.6,23,3.2,22.9c-0.7,0-2.7-1.6-3.2-2
                ...
                <div className={classes.categoryContent}>
                  ...
                  >
                    <path
                      ...
                      d="M13.1,27l-2.9-0.8c-0.3-0.1-0.5-0.4-0.4-0.7c0,0,0,0,0,0l6.4-22c0.1-0.3,0.4-0.5,0.7-0.4
                  ...
                  <ul className={classes.categories}>
                    ...
                    <li className={classes.categoryName}>
                ...
                <div className={classes.formationContent}>
                  ...
                  <div className={classes.content}>
                    ...
                    <div className={classes.formationTitles}>
                      <span className={classes.formationTitle}>
                        Master UI/UX Design
                      </span>
                      <span className={classes.formationSubtitle}>
                  ...
                  <div className={classes.content}>
                    <div className={classes.imgMask}>
                      <div className={classes.openclassroom}>
                        <Image
                          src="/assets/images/openclassroom.jpg"
                          alt=""
                          width="200"
                          height="200"
                        />
              ...
              <div className={classes.profileContent}>
                <div className={classes.similaryContent}>
                  ...
                  <div className={classes.similaryStudent}>
                    <div className={classes.imgMask}>
                      <Image
                        src="/assets/images/research/photo_21.jpg"
                        alt=""
                        width="1080"
                        height="1620"
                      />
                    ...
                    <div className={classes.studentInfo}>
                      ...
                      <span className={classes.studentJob}>
                        Intégrateur Web
                      </span>
                    </div>
                  </div>
                  <div className={classes.similaryStudent}>
                    <div className={classes.imgMask}>
                      <Image
                        src="/assets/images/research/photo_22.jpg"
                        alt=""
                        width="1080"
                        height="1620"
                      />
                  ...
                  <div className={classes.similaryStudent}>
                    <div className={classes.imgMask}>
                      <Image
                        src="/assets/images/research/photo_11.jpg"
                        alt=""
                        width="1080"
                        height="1620"
                      />
